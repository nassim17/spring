...
public class AccountBankController {
    ...
    @PostMapping("/local-updateAccount")
    public String localUpdateAccount(@RequestBody AccountBankA accountBankA) {
        try {
            accountBankAService.localCreateOrUpdateAccountBank(accountBankA);
            return "Account updated and message sent to ActiveMQ";
        } catch (RuntimeException e) {
            return "Error: " + e.getMessage();
        }
